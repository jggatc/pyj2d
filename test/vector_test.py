...
def test_vector_operator():
    ...
    v1 = Vector2(2.0, 3.0)
    v2 = Vector2(3.0, 4.0)
    assert (v1 + v2) == (5.0, 7.0)
    assert (v1 + (3.0,4.0)) == (5.0, 7.0)
    assert (v1 - v2) == (-1.0, -1.0)
    assert (v1 - (3.0,4.0)) == (-1.0, -1.0)
    assert (v1 * v2) == 18.0
    assert (v1 * (3.0,4.0)) == 18.0
    assert (v1 * 2) == (4.0, 6.0)
    assert (v1 / 2) == (1.0, 1.5)
    assert (v1 // 2) == (1.0, 1.0)
    #ts tuple __add__ not __radd__ pyjsobj fix
    assert ((2.0,3.0) + v2) == (5.0, 7.0)
    assert ((2.0,3.0) - v2) == (-1.0, -1.0)
    #ts tuple __mul__ not __rmul__ pyjsobj fix
    ...
    v = Vector2(v1)
    el = v.elementwise()
    assert (el + v2) == (5.0, 7.0)
    assert (el - v2) == (-1.0, -1.0)
    assert (el * v2) == (6.0, 12.0)
    vx = (el / v2)
    assert (_rd(vx[0]), _rd(vx[1])) == (0.667, 0.75)
    assert (el // v2) == (0.0, 0.0)
    assert (v2 + el) == (5.0, 7.0)
    assert (v2 - el) == (1.0, 1.0)
    assert (v2 * el) == (6.0, 12.0)
    vx = (v2 / el)
    assert (_rd(vx[0]), _rd(vx[1])) == (1.5, 1.333)
    assert (v2 // el) == (1.0, 1.0)
    assert (el + (3.0,4.0)) == (5.0, 7.0)
    assert (el - (3.0,4.0)) == (-1.0, -1.0)
    assert (el * (3.0,4.0)) == (6.0, 12.0)
    vx = (el / (3.0,4.0))
    assert (_rd(vx[0]), _rd(vx[1])) == (0.667, 0.75)
    assert (el // (3.0,4.0)) == (0.0, 0.0)
    #ts tuple __add__ not __radd__ pyjsobj fix
    assert ((3.0,4.0) + el) == (5.0, 7.0)
    assert ((3.0,4.0) - el) == (1.0, 1.0)
    #ts tuple __mul__ not __rmul__ pyjsobj fix
    assert ((3.0,4.0) * el) == (6.0, 12.0)
    vx = ((3.0,4.0) / el)
    assert (_rd(vx[0]), _rd(vx[1])) == (1.5, 1.333)
    assert ((3.0,4.0) // el) == (1.0, 1.0)
    assert (el + 2) == (4.0, 5.0)
    ...
    assert (v1 != v1) == False
    assert (v1 != v2) == True
    assert (v1 == (2.0,3.0)) == True
    assert (v1 == (3.0,4.0)) == False
    assert (v1 != (2.0,3.0)) == False
    assert (v1 != (3.0,4.0)) == True
    assert (v1 == 2) == False
    assert (v1 != 2) == True
    assert (el == el) == True
    assert (el != el) == False
